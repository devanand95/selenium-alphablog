...
Before('@javascript') do |scenario|
  ...
  Capybara.register_driver :selenium do |app|
        ...
        # sleep ENV['TEST_ENV_NUMBER'].to_i
        # Capybara::Selenium::Driver.new(app, browser: :firefox, http_client: http_client,:desired_capabilities => capabilities)
        options = Selenium::WebDriver::Chrome::Options.new
        #options.add_argument("--headless")
        options.add_argument("--start-maximized")
        Selenium::WebDriver::Chrome::Service.driver_path = "/home/deva/Downloads/chromedriver_91/chromedriver"
